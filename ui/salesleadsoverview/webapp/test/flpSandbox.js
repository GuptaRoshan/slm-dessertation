		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#slosalesleadsoverview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"slosalesleadsoverview-display": {
								"semanticObject": "slosalesleadsoverview",
								"action": "display",
								"description": "Sales Leads Overview",
								"title": "Sales Leads Overview",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=slo.salesleadsoverview",
									"url": sap.ui.require.toUrl("slo/salesleadsoverview")
								}
							}
						}
					}
